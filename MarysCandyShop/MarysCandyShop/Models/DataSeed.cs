...
namespace MarysCandyShop.Models
{
    ...
    {
        string[] candyNames = { "Rainbow Lollipops", "Cotton Candy Clouds", "Choco-Caramel Delights", "Gummy Bear Bonanza", "Minty Chocolate Truffles", "Jellybean Jamboree",
                                "Jellybean Jamboree", "Sour Patch Surprise", "Crispy Peanut Butter", "Cups", "Rock Candy Crystals"};
